...
Game.Launch=function()
{
	...
	'<div class="section">'+loc("MILF.TINEKESIEDERS.NL UPDATES")+'</div>'+
    ...
    '<div class="listing">&bull; Updates waren kapot, Nu niet meer</div>'+
	...
	'<div class="listing">&bull; Iedereen wist het binnen 4.287 seconden</div>'+
	'<div class="listing">&bull; Site was binnen 3 minuten weggehaald...</div>'+
	'<div class="listing">&bull; tja...</div>'+
	'</div>'+
	'</div>'
	;
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarIGM'),'<div style="padding:8px;width:250px;text-align:center;">Doe dat rechts boven!</div>','this');
			l('changeLanguage').innerHTML=loc("Naar de betere taal gaan");
			l('links').childNodes[0].nodeValue=loc("Hoi :)");
